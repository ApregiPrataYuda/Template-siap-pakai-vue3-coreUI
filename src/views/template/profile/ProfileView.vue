...
.stats-card,
.detail-card {
  background: var(--bg-card);        /* ← ganti dari hardcode */
  border-radius: 12px;
  box-shadow: 0 1px 3px var(--shadow-color);
  overflow: hidden;
}
...
.profile-avatar {
  ...
  align-items: center;
  justify-content: center;
  border: 4px solid var(--bg-card);  /* ← ganti */
  margin-top: -36px;
  flex-shrink: 0;
}
.profile-name {
  font-size: 1.1rem;
  font-weight: 700;
  color: var(--text-primary);        /* ← ganti */
  margin-top: 10px;
}
.profile-role {
  font-size: 0.82rem;
  color: var(--text-muted);          /* ← ganti */
  margin-top: 2px;
}
.profile-tags {
  display: flex;
...
.info-row {
  ...
  justify-content: space-between;
  padding: 12px 0;
  border-bottom: 1px solid var(--border-main);  /* ← ganti */
  gap: 16px;
}
.info-row:last-child { border-bottom: none; }
.info-label {
...
.form-input {
  padding: 9px 12px;
  border: 1px solid var(--border-main);         /* ← ganti */
  border-radius: 8px;
  font-size: 0.875rem;
  background: var(--bg-input);       /* ← ganti */
  color: var(--text-primary);        /* ← ganti */
  outline: none;
  transition: border 0.18s ease;
}
...
.activity-item:hover { background: var(--bg-nav-hover); }  /* ← ganti */
.activity-icon {
  width: 36px;
  height: 36px;
  border-radius: 9px;
